...
insert into tasks (id, title, gtdproject_id, gtduser_id, context_id, startdate, completeddate, isDone, status) values(1, 'Test Task', 1, 1, 1, '2011-12-26 00:00:00', '2011-12-28 00:00:00', 0, 'SCHEDULED')
